...
py -m pip install azure-datalake-store -i http://mirrors.aliyun.com/pypi/simple/ --trusted-host mirrors.aliyun.com
py -m pip install azure-mgmt-resource -i http://mirrors.aliyun.com/pypi/simple/ --trusted-host mirrors.aliyun.com
